            ...
            steps {
                script {
                    ...
                    dir(workspaceDir) {
                        ...
                        checkout([$class: 'GitSCM', branches: [[name: '*/master']], userRemoteConfigs: [[url: 'https://github.com/novablack6/gradle-simple.git']], extensions: [[$class: 'SparseCheckoutPaths', sparseCheckoutPaths: [[path: 'test_git/*']]]]])
